    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>perfil/remover-mensagens" class="last">Remover mensagens</a>
            </div>

            <h2 class="titulo">Remover mensagens</h2>
            ...
            <div style="padding:13px;font-size:13px;display: flex;justify-content: center;align-items: center;flex-direction: column;">
                <table>
                    ...
                    <?php foreach ($mensagens as $mensagem) : ?>
                        <tr>
                            <td><?php echo $mensagem['msg']; ?> - <?php echo $mensagem['mensagem_nickname']; ?></td>
                            <td><a href="<?php echo BASE; ?>perfil/deletarMensagem/<?php echo $mensagem['id']; ?>" class="btn btn-danger">Deletar</a></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
