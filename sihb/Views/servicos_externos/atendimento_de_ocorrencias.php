    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>servicos-externos/atendimento-de-ocorrencias" class="last">Atendimento de Ocorrências</a>
            </div>

            <h2 class="titulo">Atendimento de Ocorrências</h2>
