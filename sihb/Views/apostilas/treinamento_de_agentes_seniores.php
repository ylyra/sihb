    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>apostilas/treinamento-de-agentes-seniores" class="last">Treinamento de Agentes Seniores</a>
            </div>

            <h2 class="titulo">Treinamento de Agentes Seniores</h2>
