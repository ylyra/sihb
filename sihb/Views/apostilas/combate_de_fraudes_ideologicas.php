    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>apostilas/combate-de-fraudes-ideologicas" class="last">Combate de Fraudes Ideológicas</a>
            </div>

            <h2 class="titulo">Combate de Fraudes Ideológicas</h2>
