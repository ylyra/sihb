    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>financeiro">Financeiro</a>
                <a href="<?php echo BASE; ?>financeiro/sistema-de-indicacao" class="last">Sistema de Indicações</a>
            </div>

            <h2 class="titulo">Sistema de Indicações</h2>
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    <li><a href="<?php echo BASE; ?>financeiro/cargos-pagos" class="last">Cargos Pagos</a></li>
                    <li><a href="<?php echo BASE; ?>financeiro/sihbcoins" class="last">SIHBCoins</a></li>
                    <li><a href="<?php echo BASE; ?>financeiro/salarios" class="last">Salários</a></li>
                    <!-- <li><a href="<?php echo BASE; ?>financeiro/sistema-de-indicacao" class="last">Sistema de Indicações</a></li> -->
                </ul>
            </div>
