    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>noticias">Notícias</a>
                <a href="<?php echo BASE; ?>noticias/equipe" class="last">Colunas</a>
            </div>

            <h2 class="titulo">Colunas</h2>

            <div style="padding:13px;font-size:13px;display: flex;justify-content: center;align-items: center;flex-direction: column;"></div>
        </div>
        <!-- ./DESTAQUE SEMANAL E PESQUISA -->
        ...
        <div class="radio-buttons">
            ...
            <div class="relacionadas mt-10">
                ...
                <ul>
                    ...
                    <li class="active"><a href="<?php echo BASE; ?>noticias/colunas">Colunas</a></li>
                    <li><a href="<?php echo BASE; ?>noticias/faca-parte">Faça Parte</a></li>
                </ul>
            </div>
        </div>
        <!-- ./RÁDIO, NAVEGAÇÃO RÁPIDA E LINKS -->
