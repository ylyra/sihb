    ...
    <div id="radio-pesquisa" class="container pags">
        ...
        <div style="width: 730px;padding:10px;" class="comum">
            ...
            <div class="breadcrumb">
                ...
                <a href="<?php echo BASE; ?>departamentos">Departamentos</a>
                <a href="<?php echo BASE; ?>departamentos/educacao-e-civismo" class="last">Educação e Civismo</a>
            </div>

            <h2 class="titulo">Educação e Civismo</h2>
