...
<?php endif; ?>
<div class="card">
    <h5 class="card-header">Emblemas</h5>
    <div class="card-body">
        <a href="<?php echo BASE; ?>loja/addEmblema" class="btn btn-outline-dark btn-block">Adicionar Emblema</a><br/>
            ...
            <tbody>
                <?php foreach ($items as $item) : ?>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="<?php echo BASE; ?>loja/editEmblema/<?php echo $item['id']; ?>" class="btn btn-success">Editar</a>
                                <a href="<?php echo BASE; ?>loja/delEmblema/<?php echo $item['id']; ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
