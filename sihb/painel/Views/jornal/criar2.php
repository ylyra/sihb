<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo BASE; ?>jornal/update" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="status" name="status" required>
                    ...
                    <option value="0" <?php echo($noticia['status'] == 0)?'selected':''; ?> >Sem revisão</option>
                    <option value="1" <?php echo($noticia['status'] == 1)?'selected':''; ?> >Revisada</option>
                    <option value="2" <?php echo($noticia['status'] == 2)?'selected':''; ?> >Fixada</option>
                    <option value="3" <?php echo($noticia['status'] == 3)?'selected':''; ?> >Destacada</option>
